...
let loaded_comments_plugin="v2.9"
...
noremap  <silent> <C-B> :call UnCommentLine()<CR>
" key-mappings for range un-comment lines in visual <Shift-V> mode
vnoremap <silent> <C-B> :call RangeUnCommentLine()<CR>
...
function! CommentLine()
  ...
  elseif file_name =~ '\.f90$' || file_name =~ '\.F90$' || file_name =~ '\.f95$' || file_name =~ '\.F95$'
    execute ":silent! normal ^i!\<ESC>\<down>^"
  " for VHDL files use -- 
  elseif file_name =~ '\.vhd$' || file_name =~ '\.vhdl$'
