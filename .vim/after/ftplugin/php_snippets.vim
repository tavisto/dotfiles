...
exec "Snippet phpp <?php<CR>".st.et."<CR>"
...
exec "Snippet die die (\"".st."string".et."\")".st.et.";".st.et."<CR>".st.et
exec "Snippet print_r print_r(  ".st."variable".et." )".st.et.";".st.et."<CR>".st.et
